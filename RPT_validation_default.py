...
all_datasets = ['LiarPantsOnFire','polarity_dataset_v2.0_pang_cs_cornell_embed','ecoli','steel_plates_faults','heloc_new']


all_datasets = ['polarity_dataset_v2.0_pang_cs_cornell_embed']


results_folder = "datasets/PIVOT_FOREST_DEFAULT_validation_OS_64"
...
for name in all_datasets:
  ...
  #  result = get_stumps_forest(data)
   ...
   # data_pivots
    ...
    results_df.to_csv(f'datasets/PIVOT_FOREST_DEFAULT_validation_OS_64/mstz_{dataset_name}_results_simple.csv', index = False)
    ...
    grouped_results.to_csv(f'datasets/PIVOT_FOREST_DEFAULT_validation_OS_64/mstz_{dataset_name}_grouped_simple.csv', index = False)
