...
all_datasets = ['doctoral', 'yeast_new', 'algerian_forest_fires_new','iris_new','wine_new','page_blocks_binary_new','spambase_new','compas_new','magic_new','house16_new'] + all_datasets

all_datasets = ['LiarPantsOnFire']


results_folder = "datasets/PIVOT_FOREST_DEFAULT_testing_OS_32"
...
for name in all_datasets:
   ...
   # data_pivots
    ...
    results_df.to_csv(f'datasets/PIVOT_FOREST_DEFAULT_testing_OS_32/mstz_{dataset_name}_results_simple.csv', index = False)
    ...
    grouped_results.to_csv(f'datasets/PIVOT_FOREST_DEFAULT_testing_OS_32/mstz_{dataset_name}_grouped_simple.csv', index = False)
