...
results_folder = "datasets/kfold_res"
...
for name in all_datasets:
    ...
    results_df.to_csv(f'datasets/kfold_res/mstz_{dataset_name}_results.csv', index = False)
...
# In[29]:
    ...
    grouped_results.to_csv(f'datasets/kfold_res/mstz_{dataset_name}_grouped.csv', index = False)
