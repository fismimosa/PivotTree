...
all_datasets =['SVHN','vicunaspotify', 'palmTED', 'tennisgpt']


all_datasets = ['tennisgpt','palmTED']

results_folder = "datasets/subset_PIVOT_FOREST_DEFAULT_validation_OS_64"
...
for name in all_datasets:
  ...
  #  result = get_stumps_forest(data)
   ...
   # data_pivots
    ...
    results_df.to_csv(f'datasets/subset_PIVOT_FOREST_DEFAULT_validation_OS_64/mstz_{dataset_name}_results_simple.csv', index = False)
    ...
    grouped_results.to_csv(f'datasets/subset_PIVOT_FOREST_DEFAULT_validation_OS_64/mstz_{dataset_name}_grouped_simple.csv', index = False)
