...
results_folder = "datasets/subset_RANDOM_FOREST_DEFAULT_validation"
...
for name in all_datasets:
  ...
  #  result = get_stumps_forest(data)
   ...
   # data_pivots
    ...
    with parallel_backend('loky', n_jobs=8):
        ...
        for fold_idx, (fold_tuple, fold_matrix) in enumerate(zip(folds, folds_proximity_matrix)):
            ...
            for e, combination in enumerate(param_combinations):
                ...
                rt = RuleForestClassifier(**params, n_jobs = 8)
    ...
    results_df.to_csv(f'datasets/subset_RANDOM_FOREST_DEFAULT_validation/mstz_{dataset_name}_results_simple.csv', index = False)
    ...
    grouped_results.to_csv(f'datasets/subset_RANDOM_FOREST_DEFAULT_validation/mstz_{dataset_name}_grouped_simple.csv', index = False)
