...
results_folder = "datasets/RANDOM_FOREST_DEFAULT_validation"
...
for name in all_datasets:
  ...
  #  result = get_stumps_forest(data)
   ...
   # data_pivots
    ...
    results_df.to_csv(f'datasets/RANDOM_FOREST_DEFAULT_validation/mstz_{dataset_name}_results_simple.csv', index = False)
    ...
    grouped_results.to_csv(f'datasets/RANDOM_FOREST_DEFAULT_validation/mstz_{dataset_name}_grouped_simple.csv', index = False)
