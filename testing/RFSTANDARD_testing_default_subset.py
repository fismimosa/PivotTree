...
results_folder = "datasets/subset_RANDOM_FOREST_DEFAULT_testing"
...
for name in all_datasets:
  ...
  #  result = get_stumps_forest(data)
   ...
   # data_pivots
    ...
    results_df.to_csv(f'datasets/subset_RANDOM_FOREST_DEFAULT_testing/mstz_{dataset_name}_results_simple.csv', index = False)
    ...
    grouped_results.to_csv(f'datasets/subset_RANDOM_FOREST_DEFAULT_testing/mstz_{dataset_name}_grouped_simple.csv', index = False)
