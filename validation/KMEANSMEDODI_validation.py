...
results_folder = "datasets/KME_MED_RIGHT_validation"
...
for name in all_datasets:
    ...
    results_df.to_csv(f'datasets/KME_MED_RIGHT_validation/mstz_{dataset_name}_results.csv', index = False)
    ...
    grouped_results.to_csv(f'datasets/KME_MED_RIGHT_validation/mstz_{dataset_name}_grouped.csv', index = False)
