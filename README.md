...
```BoundaryVisualization.ipynb``` shows code with deptiction of different boundary of univariate, oblique and proximity based splits for different versions of ```PivotTree```
