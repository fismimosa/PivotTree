...
results_folder = "datasets/eps_testing"
...
for name in all_datasets:
    ...
    distances = X_train_matrix.flatten()  # Flatten the matrix to a 1D array
    ...
    results_df.to_csv(f'datasets/eps_testing/mstz_{dataset_name}_results.csv', index = False)
    ...
    grouped_results.to_csv(f'datasets/eps_testing/mstz_{dataset_name}_grouped.csv', index = False)
