...
results_folder = "datasets/standard_kfold_res"
...
for name in all_datasets:
    ...
    results_df.to_csv(f'datasets/standard_kfold_res/mstz_{dataset_name}_results.csv', index = False)
    ...
    grouped_results.to_csv(f'datasets/standard_kfold_res/mstz_{dataset_name}_grouped.csv', index = False)
